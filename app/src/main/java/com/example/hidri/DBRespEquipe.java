...
public class DBRespEquipe extends SQLiteOpenHelper {
    public static final String name="RespEquipe.db";
    public static final String TableName ="respEquipe_table";
    ...
    public DBRespEquipe( Context context) {
