...
class JavaMailAPi extends AsyncTask<Void,Void,Void>  {
    ...
    protected void onPreExecute() {
        ...
        mProgressDialog = ProgressDialog.show(mContext,"Envoi du message", "S'il vous plaît, attendez...",false,false);
    }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        //Show success toast
        Toast.makeText(mContext,"Message Envoyé",Toast.LENGTH_SHORT).show();
    }
