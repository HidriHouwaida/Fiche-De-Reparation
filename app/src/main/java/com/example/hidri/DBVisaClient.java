...
public class DBVisaClient extends SQLiteOpenHelper {
    public static final String name="VisaClient.db";
    public static final String TableName ="visaclient_table";
    ...
    public DBVisaClient( Context context) {
