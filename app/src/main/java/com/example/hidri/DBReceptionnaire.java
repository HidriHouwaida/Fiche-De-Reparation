...
public class DBReceptionnaire   extends SQLiteOpenHelper {
    public static final String name="Receptionnaire.db";
    public static final String TableName ="receptionnaire_table";
    ...
    public DBReceptionnaire( Context context) {
