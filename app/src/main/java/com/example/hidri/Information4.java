...
public class Information4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //button next pour aller vers l'activité Information5
        //******************************************************************************************
        next=findViewById(R.id.next);
        next.setOnClickListener(v -> {
            Intent intent1 =new Intent(getApplicationContext(),Information5.class);
